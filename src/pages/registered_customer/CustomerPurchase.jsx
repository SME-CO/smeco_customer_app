      ...
      <div className="pt-8 md:ml-60">
        ...
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-4 pb-10 pt-12 pl-24">
          ...
          <div className="flex flex-col justify-center pl-12">
            ...
            <p className="text-xl  pt-3">
              <b>Discription :</b> Silver coated belt
              <br />
            </p>
          </div>
        ...
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-4 pb-10 pt-12  pl-24">
          ...
          <div className="flex flex-col justify-center pl-12">
            ...
            <p className="text-xl  pt-3">
              <b>Discription :</b> Different colours available
              <br />
            </p>
          </div>
          <div className="pt-44 pl-32">
        ...
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-4 pb-10 pt-12  pl-24">
          ...
          <div className="flex flex-col justify-center pl-12">
            ...
            <p className="text-xl  pt-3">
              <b>Discription :</b> Branded last 2 pieces available (Black)
              <br />
            </p>
          </div>
          <div className="pt-44 pl-32">
